...
<br /><br /></span>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hoangntph04036_nhom7ConnectionString10 %>" DeleteCommand="DELETE FROM [khach_hang] WHERE [ma] = @ma" InsertCommand="INSERT INTO [khach_hang] ([ma], [ten_day_du], [email], [sdt]) VALUES (@ma, @ten_day_du, @email, @sdt)" SelectCommand="SELECT [ma], [ten_day_du], [email], [sdt] FROM [khach_hang]" UpdateCommand="UPDATE [khach_hang] SET [ten_day_du] = @ten_day_du, [email] = @email, [sdt] = @sdt WHERE [ma] = @ma">
                <DeleteParameters>
            ...
            <asp:ListView ID="ListView2" runat="server" DataSourceID="SqlDataSource2" EnableModelValidation="True"></asp:ListView>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\hoangntph04036_nhom7.mdf;Integrated Security=True;Connect Timeout=30" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [khach_hang]"></asp:SqlDataSource>
        </div>
        <div class="clearfix">
        </div>
    </section>
