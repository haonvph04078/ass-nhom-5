        ...
        <div class="container">
            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="ma" DataSourceID="SqlDataSource1" EnableModelValidation="True" InsertItemPosition="LastItem">
                <AlternatingItemTemplate>
                    ...
                    <br />
                    Tên Loại :
                    <asp:Label ID="ten_loai_san_phamLabel" runat="server" Text='<%# Eval("ten_loai_san_pham") %>' />
                    <br />
...
<br /><br /></span>
                ...
                <EditItemTemplate>
                    ...
                    <br />
                    Tên Loại :
                    <asp:TextBox ID="ten_loai_san_phamTextBox" runat="server" Text='<%# Bind("ten_loai_san_pham") %>' />
                    <br />
...
<br /><br /></span>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hoangntph04036_nhom7ConnectionString10 %>" DeleteCommand="DELETE FROM [loai_san_pham] WHERE [ma] = @ma" InsertCommand="INSERT INTO [loai_san_pham] ([ma], [ten_loai_san_pham]) VALUES (@ma, @ten_loai_san_pham)" SelectCommand="SELECT [ma], [ten_loai_san_pham] FROM [loai_san_pham]" UpdateCommand="UPDATE [loai_san_pham] SET [ten_loai_san_pham] = @ten_loai_san_pham WHERE [ma] = @ma">
                <DeleteParameters>
