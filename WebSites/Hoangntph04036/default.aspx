...
<body>
            ...
            <div class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        role="button" aria-haspopup="true" aria-expanded="false" runat="server">Quản lý<span class="caret"
                            runat="server"></span></a>
                    ...
                    <li><a href="contact.htm" runat="server">Liên hệ</a></li>
                    <li>
                        <!-- add search form -->
    ...
    <section id="services" class="padding50">
        ...
        <div class="container">
            <!-- ./ end row -->
            <!-- ./ end row -->
            <asp:DataList ID="DataList1" runat="server" DataKeyField="ma" DataSourceID="SqlDataSource1">
                <ItemTemplate>
...
<br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hoangntph04036_nhom7ConnectionString10 %>" SelectCommand="SELECT [ma], [ma_loai_san_pham], [ma_so], [ten_san_pham], [gia], [mo_ta], [anh], [don_vi_tinh] FROM [san_pham]"></asp:SqlDataSource>
        </div>
        <div class="clearfix">
        </div>
    </section>
