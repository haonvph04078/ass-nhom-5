...
<br /><br /></span>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:hoangntph04036_nhom7ConnectionString10 %>" DeleteCommand="DELETE FROM [hoa_don_chi_tiet] WHERE [ma] = @ma" InsertCommand="INSERT INTO [hoa_don_chi_tiet] ([ma], [ma_hoa_don], [ma_san_pham], [so_luong], [thanh_tien]) VALUES (@ma, @ma_hoa_don, @ma_san_pham, @so_luong, @thanh_tien)" SelectCommand="SELECT [ma], [ma_hoa_don], [ma_san_pham], [so_luong], [thanh_tien] FROM [hoa_don_chi_tiet]" UpdateCommand="UPDATE [hoa_don_chi_tiet] SET [ma_hoa_don] = @ma_hoa_don, [ma_san_pham] = @ma_san_pham, [so_luong] = @so_luong, [thanh_tien] = @thanh_tien WHERE [ma] = @ma">
                <DeleteParameters>
